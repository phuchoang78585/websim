...
public class DateUtil {
	...
	public static long getDateToClient(Date start,Date end) {
		long secs = start.getTime()/1000;
		System.out.println(secs);
		long secs1 = end.getTime()/1000;
	...
	public static String formatDate(Date dt) {
		...
		if (dt == null)
			dt = new Date();
		SimpleDateFormat format = new SimpleDateFormat(AppConstants.DEFAULT_DATE_FORMAT);
	...
	public static String formatYear(Date dt) {
		...
		if (dt == null)
			return null;
		SimpleDateFormat format = new SimpleDateFormat(AppConstants.DEFAULT_DATE_FORMAT_YEAR);
		return format.format(dt);
	...
	public static Date getDate(String date) throws Exception {
		DateFormat myDateFormat = new SimpleDateFormat(AppConstants.DEFAULT_DATE_FORMAT);
	...
	public static Date addSecondsToCurrentDate(int second) {
		Calendar c = Calendar.getInstance();
		c.setTime(new Date());
	...
	public static void main(String[] args) {
		Date nowSecond = addSecondsToCurrentDate(120);
		System.out.println(nowSecond.toLocaleString());
	}
	...
	public static LocalDateTime pareTime(String date) {
